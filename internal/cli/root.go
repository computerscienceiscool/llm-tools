...
func init() {
	...
	// Exec flags
	rootCmd.PersistentFlags().Bool("exec-enabled", false, "Enable exec command")
	...
	rootCmd.PersistentFlags().Bool("io-containerized", false, "Enable containerized file I/O operations")
